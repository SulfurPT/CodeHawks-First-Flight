...
contract PuppyRaffleTest is Test {
    ...
    function testChangeFeeAddress(address x) public {
        address newFeeAddress = address(x);
    ...
    function testCanGetRefundReentracy() public {
        ...
        // impact
        console2.log("attackerContract balance: ", startingAttackContractBalance);
        console2.log("puppyRaffle balance: ", startingPuppyRaffleBalance);
        console2.log("ending attackerContract balance: ", address(attackerContract).balance);
        console2.log("ending puppyRaffle balance: ", address(puppyRaffle).balance);
    }
}
